            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>:
                                    ...
                                    <a href="{{ asset('storage/' . $model->bukti_bayar) }}" target="_blank" class="btn btn-success btn-sm">
                                    Lihat Bukti Bayar
                                    @else
                            ...
                            <tr>
                                ...
                                <td>:
                                    ...
                                    <span class="badge rounded-pill text-bg-danger">{{ ucwords($model->status_konfirmasi) }} oleh Operator</span>
                                    @else
                                    <span class="badge rounded-pill text-bg-success">{{ ucwords($model->status_konfirmasi) }} oleh Operator</span>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:
                                    ...
                                    <span class="badge rounded-pill text-bg-danger">Belum dikonfirmasi oleh Operator</span>
                                    @else
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-danger mt-2">BATALKAN PEMBAYARAN</button>
                        {!! Form::close() !!}
                    </div>
                    @endif
                </div>
